...
export default function AdminSettings() {
  ...
  return (
    <Layout mode="admin" title="Settings" subtitle="Configuración general de la plataforma">
      <div className="glass-card p-4 mb-6 border-amber-400/20 bg-amber-400/5 flex items-start gap-3 max-w-xl">
        ...
        <p className="text-sm text-amber-200">
          Esta plataforma no procesa pagos reales ni permite depósitos o retiros. Todos los ajustes afectan
      ...
      <div className="glass-card p-6 max-w-md space-y-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1.5">
            Cantidad de créditos virtuales que reciben las nuevas cuentas nuevas automáticamente.
          </p>
        </div>
